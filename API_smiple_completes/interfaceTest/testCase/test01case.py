...
from interfaceTest.geturlParams import geturlParams
from interfaceTest.readExcel import readExcel
# pythoncom.CoInitialize()

url = geturlParams().get_Url()# 调用我们的geturlParams获取我们拼接的URL
login_xls = readExcel().get_xls('userCase.xlsx', 'login')
# login_tuple = (tuple(i) for i in login_xls)
# data = tuple(login_tuple)
...
class testUserLogin(unittest.TestCase):
    ...
    def checkResult(self):# 断言
        ...
        # print("new_url 的值{}".format(new_url))
        ...
        # print(type(info))
        # print("打印info 的值{}".format(info))
        # print("打印data1 的值{}".format(data1))
