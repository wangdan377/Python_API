...
class Otc(env_class.EnvClass,base_action.BaseAction):
    user_is_valid = True
    ...
    def create_ad(self,coin_name,ad_type,amount,min_limit,max_limit,is_bank =0,is_alipay=0,is_wechatpay=0):
        return self.otc_api_client.create_ad(coin_name,ad_type,is_bank,is_alipay,is_wechatpay,amount,min_limit,max_limit,self.session)
    @allure.step("获取广告列表")
