'''
@Author: xiaomin
@Date: 2020-04-29 17:45:52
@LastEditTime: 2020-05-11 11:15:33
@LastEditors: xiaomin
@Description: 用户的设备服务调用流程
@FilePath: \ioT-uat\Testcase\test16_userdevice04.py
'''
...
from Params.params import userDeviceTest04
...
@ddt.ddt
class userDeviceTest_04(loginToken):
    '''
    创建产品-创建设备-绑定设备-定义优模型属性-发布产品-设置属性-查询属性-批量设置属性-查询属性-设置期望属性值-查询期望属性值
    '''
    @ddt.data({'title':'直连产品','dataFormat':'1','networkType':'WIFI','productName':'apitest_auto43','productNodeType':'0','sub':'false'},
              {'title':'网关子设备产品','dataFormat':'0','networkType':'WIFI','productName':'apitest_auto44','productNodeType':'0','sub':'true'},
              {'title':'边缘网关产品','dataFormat':'1','networkType':'WIFI','productName':'apitest_auto45','productNodeType':'2','sub':'false'})
    @ddt.unpack
    def test_userdevice_04(self,dataFormat,networkType,productName,productNodeType,sub,title):
        ...
        '''获取test_userdevice4.yaml中的数据'''
        data=userDeviceTest04()
        ...
        '''查询产品优模型id'''
        if para[1]['productName']=='apitest_auto45':
