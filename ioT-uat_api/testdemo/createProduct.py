...
for i in range(0,65):
    param={
        ...
        "productGroup":"",
        "productName":"apitest_batch"+str(i),
        "productNodeType":"0",
        "productType":"",
        "sub":"false"
    }
    response= requests.post(url='https://mobileuat.utcook.com/iotapp/product/create',headers=header,data=json.dumps(param).encode("utf-8"))
    pro=json.loads(response.text)
    productkey.append(pro['productKey'])
    print(productkey)