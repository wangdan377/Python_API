...
for i in range(15063,20000):
    param={
        "deviceName":"apitest_wifi_"+str(i),
        "productKey":"a1QpTV23UgL",
        "nickname":"apitest_wifi_"+str(i)
    }
    response= requests.post(url='https://mobileuat.utcook.com/iotapp/device/create',headers=header,data=json.dumps(param).encode("utf-8"))
    print("------"+str(i))
    print(response.text)