...
for i in range(1,95):
    param={
        ...
        "identifier":"apitest_00"+str(i),
        "name":"apitest_00"+str(i),
        "type": "info",
        "outputData":[]
    }
    response= requests.post(url='https://mobileuat.utcook.com/utmodel/modelEventDeveloper/create',headers=header,data=json.dumps(param).encode("utf-8"))
    print(response.text)
