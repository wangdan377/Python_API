...
class Attendance_statistics_single_oneMonth:

    @allure.severity('normal')
    @allure.feature('Attendance_statistics')
    @allure.story('Attendance_statistics_single_oneMonth')
    def test_single_oneMonth_01(self):
        ...
        url_statistics_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/statlist?startDate=2019-10-01&endDate=2019-10-31&userIds=201866124728146616'
        #获取用户 201866124728146616 2019年10月 考勤统计结果
...
if __name__ == '__main__':
    a = Attendance_statistics_single_oneMonth()
    a.test_single_oneMonth_01()
