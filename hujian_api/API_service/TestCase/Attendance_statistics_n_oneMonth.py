...
class Attendance_statistics_n_oneMonth:

    @allure.severity('normal')
    @allure.feature('Attendance_statistics')
    @allure.story('Attendance_statistics_n_oneMonth')
    def test_n_oneMonth_01(self):
        ...
        url_statistics_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/statlist?startDate=2019-10-01&endDate=2019-10-31&userIds=201866124728146616,056621220036405378,066132052329547237'
        #获取用户 201866124728146616 056621220036405378 066132052329547237 2019年10月 考勤统计结果
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dutyDays, 19)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_abnormalDates, 7)
        Consts.RESULT_LIST.append('True')
        ...
        #Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dinnerCount, 8)
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dutyDays2, 19)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_abnormalDates2, 7)
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dutyDays3, 19)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_abnormalDates3, 7)
        Consts.RESULT_LIST.append('True')
...
if __name__ == '__main__':
    a = Attendance_statistics_n_oneMonth()
    a.test_n_oneMonth_01()
