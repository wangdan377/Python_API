...
class Attendance_analyse_combine_01:
    ...
    def test_combine_01(self):
        ...
        url_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-10-01 00:00:00&endDate=2019-10-31 00:00:00&userIds=124734644336498201'
        #分析 用户124734644336498201 2019年10月 考勤
        ...
        url_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&userIds=124734644336498201'
        # 分析 用户124734644336498201 2019年11月 考勤
        ...
        url_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&userIds=124734644336498201'
        # 分析 用户124734644336498201 2019年12月 考勤
        ...
        url_result_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=124734644336498201&startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&pageSize=31'
        # 获取 用户124734644336498201 2019年11月 考勤分析结果
        ...
        url_result_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=124734644336498201&startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&pageSize=31'
        # 获取 用户124734644336498201 2019年12月 考勤分析结果
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_22, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_23, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_24, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_25, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_11_01, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_07, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_08, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_11_11, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_12, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_13, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_14, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_22, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_23, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_24, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_25, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')

        assert ass.assert_in_text(resInfo_11_26, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_03, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_12_06, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_12_11, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_25, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
...
if __name__ == '__main__':
    a = Attendance_analyse_combine_01()
    a.test_combine_01()
