...
class Attendance_analyse_leave_01:

    @allure.severity('normal')
    @allure.feature('Attendance_analyse')
    @allure.story('Attendance_analyse_leave')
    def test_leave_01(self):
        ...
        url_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&userIds=101237236736401301'
        # 分析 用户101237236736401301 2019年11月 考勤
        ...
        url_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&userIds=101237236736401301'
        # 分析 用户101237236736401301 2019年12月 考勤
        ...
        url_result_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=101237236736401301&startDate=2019-10-01 00:00:00&endDate=2019-10-31 00:00:00&pageSize=31'
        #获取 用户101237236736401301 2019年10月 考勤分析结果
        ...
        url_result_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=101237236736401301&startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&pageSize=31'
        # 获取 用户101237236736401301 2019年11月 考勤分析结果
        ...
        url_result_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=101237236736401301&startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&pageSize=31'
        # 获取 用户101237236736401301 2019年12月 考勤分析结果
        ...
        assert ass.assert_in_text(resInfo_10_11, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_12, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_17, 'ABNORMAL480')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_10_21, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_22, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_23, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_24, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_25, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_28, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_29, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_30, 'SUCCESS')
        Consts.RESULT_LIST.append('True')

        assert ass.assert_in_text(resInfo_10_31, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_11_21, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_22, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_27, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_28, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_29, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_02, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_03, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_04, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_05, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')

        assert ass.assert_in_text(resInfo_12_06, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_12_11, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_12_16, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_23, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_27, 'ABNORMAL480')
        Consts.RESULT_LIST.append('True')


if __name__ == '__main__':
    a = Attendance_analyse_leave_01()
    a.test_leave_01()
