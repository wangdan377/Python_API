...
class Attendance_statistics_n_spanMonth:

    @allure.severity('normal')
    @allure.feature('Attendance_statistics')
    @allure.story('Attendance_statistics_n_spanMonth')
    def test_n_spanMonth_01(self):
        session_a = requests.session()
        get_req = Get.Get()
        ass = Assert.Assertions()

        url_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-10-16 00:00:00&endDate=2019-11-15 00:00:00&userIds=201866124728146616,056621220036405378,066132052329547237'
        # 分析用户 201866124728146616 056621220036405378 066132052329547237 2019年10月16日-2019年11月15日 考勤
        ...
        url_statistics_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/statlist?startDate=2019-10-16&endDate=2019-11-15&userIds=201866124728146616,056621220036405378,066132052329547237'
        #获取用户 201866124728146616 056621220036405378 066132052329547237 2019年10月16日-2019年11月15日 考勤统计结果
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_days, 31)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dutyDays, 23)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_abnormalDates, 10)
        Consts.RESULT_LIST.append('True')
        ...
        #Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dinnerCount, 9)
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_days2, 31)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dutyDays2, 23)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_abnormalDates2, 12)
        Consts.RESULT_LIST.append('True')
        ...
        # Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dinnerCount2, 8)
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_days3, 31)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dutyDays3, 23)
        Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_abnormalDates3, 11)
        Consts.RESULT_LIST.append('True')
        ...
        # Consts.RESULT_LIST.append('True')
        assert ass.assert_text(resInfo_dinnerCount3, 8)
        Consts.RESULT_LIST.append('True')
...
if __name__ == '__main__':
    a = Attendance_statistics_n_spanMonth()
    a.test_n_spanMonth_01()
