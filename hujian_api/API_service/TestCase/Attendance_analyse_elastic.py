...
class Attendance_analyse_elastic:

    @allure.severity('normal')
    @allure.feature('Attendance_analyse')
    @allure.story('Attendance_analyse_elastic')
    def test_elastic_01(self):
        session_a = requests.session()
        get_req = Get.Get()
        ass = Assert.Assertions()

        url_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-10-01 00:00:00&endDate=2019-10-31 00:00:00&userIds=026502425537985390'
        #分析 用户026502425537985390 2019年10月 考勤
        ...
        url_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&userIds=026502425537985390'
        # 分析 用户026502425537985390 2019年11月 考勤
        ...
        url_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&userIds=026502425537985390'
        # 分析 用户026502425537985390 2019年12月 考勤
        ...
        url_result_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=026502425537985390&startDate=2019-10-01 00:00:00&endDate=2019-10-31 00:00:00&pageSize=31'
        #获取 用户026502425537985390 2019年10月 考勤分析结果
        ...
        url_result_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=026502425537985390&startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&pageSize=31'
        # 获取 用户026502425537985390 2019年11月 考勤分析结果
        ...
        url_result_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=026502425537985390&startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&pageSize=31'
        # 获取 用户026502425537985390 2019年12月 考勤分析结果
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_14, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_15, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')

        assert ass.assert_in_text(resInfo_10_16, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_28, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        assert ass.assert_in_text(resInfo_11_01, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_02, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_03, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_04, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_02, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_03, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_04, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_10, 'ABNORMAL480')
        Consts.RESULT_LIST.append('True')

        assert ass.assert_in_text(resInfo_12_11, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_12, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_17, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_18, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_19, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_20, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_24, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_25, 'ABNORMAL')
        Consts.RESULT_LIST.append('True')

        assert ass.assert_in_text(resInfo_12_26, 'SUCCESS')
        Consts.RESULT_LIST.append('True')
