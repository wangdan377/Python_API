...
class Attendance_analyse_leave_02:
    ...
    def test_leave_02(self):
        ...
        url_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-10-01 00:00:00&endDate=2019-10-31 00:00:00&userIds=061100435133840108'
        #分析 用户061100435133840108 2019年10月 考勤
        ...
        url_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&userIds=061100435133840108'
        # 分析 用户061100435133840108 2019年11月 考勤
        ...
        url_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&userIds=061100435133840108'
        # 分析 用户061100435133840108 2019年12月 考勤
        ...
        url_result_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=061100435133840108&startDate=2019-10-01 00:00:00&endDate=2019-10-31 00:00:00&pageSize=31'
        #获取 用户061100435133840108 2019年10月 考勤分析结果
        ...
        url_result_2019_11 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=061100435133840108&startDate=2019-11-01 00:00:00&endDate=2019-11-30 00:00:00&pageSize=31'
        # 获取 用户061100435133840108 2019年11月 考勤分析结果
        ...
        url_result_2019_12 = 'http://172.16.2.101:4000/api/attendance/analyse/list?userId=061100435133840108&startDate=2019-12-01 00:00:00&endDate=2019-12-31 00:00:00&pageSize=31'
        # 获取 用户061100435133840108 2019年12月 考勤分析结果
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_10_14, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_04, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_11_18, 'ABNORMAL_LEAVE')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_05, 'ABNORMAL480')
        Consts.RESULT_LIST.append('True')
        ...
        Consts.RESULT_LIST.append('True')
        assert ass.assert_in_text(resInfo_12_09, 'ABNORMAL480')
        Consts.RESULT_LIST.append('True')
