...
class Attendance_statistics_single_spanMonth:

    @allure.severity('normal')
    @allure.feature('Attendance_statistics')
    @allure.story('Attendance_statistics_single_spanMonth')
    def test_single_spanMonth_01(self):
        session_a = requests.session()
        get_req = Get.Get()
        ass = Assert.Assertions()

        url_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse?startDate=2019-10-16 00:00:00&endDate=2019-11-15 00:00:00&userIds=201866124728146616'
        # 分析用户 201866124728146616 2019年10月16日-2019年11月15日 考勤
        ...
        url_statistics_2019_10 = 'http://172.16.2.101:4000/api/attendance/analyse/statlist?startDate=2019-10-16&endDate=2019-11-15&userIds=201866124728146616'
        #获取用户 201866124728146616 2019年10月16日-2019年11月15日 考勤统计结果
...
if __name__ == '__main__':
    a = Attendance_statistics_single_spanMonth()
    a.test_single_spanMonth_01()
